...
-- 3) Update your previous query to now find unique combinations of
-- first and last name where the last name starts and ends with 'E'.
...
-- 5) Add a COUNT() to your results and use ORDER BY to make it easier
...
-- 6) Update your query for 'Irena', 'Vidya', or 'Maya'. Use count(*) and
